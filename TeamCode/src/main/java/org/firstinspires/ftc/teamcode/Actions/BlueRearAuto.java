...
@Autonomous(name="BlueRearAuto")
public class BlueRearAuto extends LinearOpMode {
    ...
    public void runOpMode () throws InterruptedException {
        ...
        Actions.runBlocking(
                drive.actionBuilder(initialPose)
                        .strafeToLinearHeading(new Vector2d(61.0,-11.8),Math.toRadians(243))
                        ...
                        .strafeToLinearHeading(new Vector2d(29.8,-26.2),Math.toRadians(270))
                        .strafeToLinearHeading(new Vector2d(29.3, -33.0),Math.toRadians(270))
                        .strafeToLinearHeading(new Vector2d(29.3,-40.0),Math.toRadians(270))
                        .strafeToLinearHeading(new Vector2d(29.3,-45.0),Math.toRadians(270))
                        .build()
        );
    }
